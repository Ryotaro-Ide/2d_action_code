...
public class SignalRoad : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 _boxDirection = Vector2.right; // ボックスの方向
    ...
    private void Update() {
        ...
        RaycastHit2D hit = Physics2D.BoxCast(boxStart, _boxSize, 0f, _boxDirection, 0f, _playerLayer);
    ...
    private void OnDrawGizmos()
    {
        ...
        Vector2 boxEnd = boxStart + (_boxDirection.normalized * 0f);
