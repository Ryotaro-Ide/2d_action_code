...
public class SignalRoad : MonoBehaviour
{
    ...
    [SerializeField] private float boxDistance = 2f; // BoxCast の距離
    ...
    private void Update() {
        ...
        RaycastHit2D hit = Physics2D.BoxCast(boxStart, boxSize, 0f, boxDirection, boxDistance, playerLayer);
    ...
    private void OnDrawGizmos()
    {
        ...
        Vector2 boxEnd = boxStart + (boxDirection.normalized * boxDistance);
